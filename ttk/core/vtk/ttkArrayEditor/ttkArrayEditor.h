...
///
/// This filter adds/removes data arrays to/form a 'vtkDataObject' (called target) based on a string and/or point/cell/field data of an optional second 'vtkDataObject' (called source).
...
class TTKARRAYEDITOR_EXPORT ttkArrayEditor : public ttkAlgorithm {
    ...
    public:
        ...
        * enumeration.
        */
        void AddArray(const int fieldType, const char* name, const int targetOrSource);
        ...
        void RemoveArray(const int fieldType, const char* name, bool deleteType, const int targetOrSource);
